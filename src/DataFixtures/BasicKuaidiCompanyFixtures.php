...
abstract class BasicKuaidiCompanyFixtures extends Fixture
{
    public const COMPANY_YUANTONG_REFERENCE = 'company-yuantong';

    public function load(ObjectManager $manager): void
    {
        foreach ($this->kuaidiCompany() as $name => $code) {
            ...
            if ('yuantong' === $code) {
                $this->setReference(self::COMPANY_YUANTONG_REFERENCE, $company);
            }
        }
