 ...
 * @internal
 */
#[CoversClass(PollRequest::class)]
final class PollRequestTest extends RequestTestCase
{
    ...
    public function testGetRequestOptions(): void
    {
        ...
        $this->assertIsString($param['company']);
        ...
        $this->assertIsArray($param['parameters']);
    ...
    public function testRequestWithExtremeValues(): void
    {
        ...
        $this->assertNotNull($options, 'getRequestOptions() should not return null');
        $this->assertIsArray($options, 'getRequestOptions() should return an array');
        $this->assertArrayHasKey('param', $options, 'Options should contain param key');
